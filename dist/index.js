...
const parseArray_1 = __webpack_require__(286);
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const coverageSummaryPath = core.getInput('coverage-summary-path');
            core.debug(`coverage-summary-path: ${coverageSummaryPath}`);
            const badgesDirectory = core.getInput('badges-directory');
